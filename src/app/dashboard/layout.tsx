...
import { LinkIcon, LayoutDashboard, Settings, BarChart2 } from "lucide-react";
      ...
      <aside className="w-full md:w-64 bg-card border-r border-border flex flex-col">
        ...
        <div className="p-4 border-t border-border mt-auto">
          <button
            ...
            className="flex w-full items-center gap-3 px-3 py-2 rounded-lg text-red-400 hover:text-red-300 hover:bg-red-400/10 transition-colors font-medium"
          >
